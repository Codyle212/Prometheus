...
# used to track count, inc at start of function, dec at end of function when file closes
...
class HandleRequests(http.server.BaseHTTPRequestHandler):
    # same as inc and dec, but built in prometheus 
    ...
    def do_GET(self):
       # REQUEST_INPROGRESS.inc()
        ...
        self.wfile.close()
        #check when was this app last served
